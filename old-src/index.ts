...
import { withErrorHandler, errorHandler } from "./utils/errors";
...
// Error handling middleware (should be registered after other middleware but before routes)
app.onError((error, c) => {
...
if (env.NODE_ENV !== "test") {
  serve(
    ...
    () => {
      // Test Docker
      fetch(`${env.DOCKER_SOCKET_PATH}/_ping`)
        .then(() => {
